...
class FastLaplacianFilter():
    ...
    def imageProcesser(self):
        ...
        cv2.imwrite("./srcRgb_gamma_{0}_alpha_{1}_beta_{2}_sigma_{3}_num_{4}_leve_{5}.png"\
...
if __name__ == '__main__':
    sTime = time.time()
    path = r"E:\local_laplacian_filter\my_laplacian\data\inputdata\flower.png"
    fastLapcian = FastLaplacianFilter(path=path,sigma= 50,alpha= 1.5,beta=1,noise=0.01,gamma=1.2).imageProcesser()
    eTime = time.time()
